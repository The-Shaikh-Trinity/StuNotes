      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li>
          <div class="flex items-center">
            ...
            <a href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-indigo-500 md:ml-2 dark:text-gray-400 ">Category</a>
          </div>
        </li>
        <li>
          <div class="flex items-center">
          ...
          <div class="text-center mb-20">
            ...
            <div class="subjects">
              ...
              ?>
                ...
                <button onclick=" window.location.href='cat.php?cat_id=<?php echo $data[$i]['id'] ?>';" class="mx-auto mx-10 mt-16 px-5  bg-sky-100 border-2 rounded p-4 h-full items-center hover:bg-white hover:text-black hover:border-2 hover:border-sky-300 cursor-pointer flex-wrap-reverse" id="buttonsub"><?php if (isset($data[$i]['sub_name'])) {

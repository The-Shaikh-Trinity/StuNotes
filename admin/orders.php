    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <table class="table table-striped table-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn  btn-outline-danger"><a style="text-decoration: none; color:black;" href="orders.php?delete=order_id">Delete</a></button>
                            </td>


                            <td>
                                <button type=" button" class="btn  btn-outline-info"><a style="text-decoration: none; color:black;" href="customers.php?id=user_id"> &nbsp;User details&nbsp; </a></button>
                        </td>
                        <td>
                            <button type="button" class="btn  btn-outline-info"><a style="text-decoration: none; color:black;" href="products.php?id=item_id">Product details</a></button>
        ...
        <form action="admin.php" method="POST">
            <div class="form-group">
                ...
                <input pattern="[A-Za-z_]{1,15}" type="text" class="form-control" placeholder="admin_fname" name="admin_fname">
            ...
            <div class="form-group">
                ...
                <input pattern="[A-Za-z_]{1,15}" id="validationTooltip01" type="text" class="form-control" placeholder="admin_lname" name="admin_lname">
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="admin_email" name="admin_email">
